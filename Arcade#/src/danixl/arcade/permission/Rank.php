...
class Rank {
	...
	public function __construct(Arcade $plugin, PermissionManager $perm) {
		$this->plugin = $plugin;
	...
	*/
    ...
    public function createFormat(Player $player) {
        ...
        $place_holder = "§f#";
            ...
            // Puts team place holder misc tag if player has team
        if($secondary == "unknown") {
            if($primary == $this->getPrimaryDefault()) {
                $format = $this->getMiscTag("default_rank_prefix") . " " . $place_holder . " " . $username . $this->getMiscTag("chat_message_prefix");
            }
            else {
                $string = "%rank% " . $place_holder . " " . $username . $this->getMiscTag("chat_message_prefix");
            ...
            if($primary == $this->getPrimaryDefault()) {
                ...
                $string = "%rank_s%" . "%rank_p% " . $place_holder . " " . $username . $this->getMiscTag("chat_message_prefix");
