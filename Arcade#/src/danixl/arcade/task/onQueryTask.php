...
class onQueryTask extends AsyncTask {
	...
	public function onCompletion(Server $server): void{
		switch($this->getMethod){
			case "syncKD":
				$server->getPluginManager()->getPlugin("Arcade")->queryTaskDone($this->getMethod, $this->getPlayer, $this->log, $this->log1);
			break;
			...
			case "playerRegistered":
				$server->getPluginManager()->getPlugin("Arcade")->queryTaskDone($this->getMethod, $this->getPlayer, $this->log);
			break;
		}
	}
}