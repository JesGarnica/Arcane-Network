...
class Area{
	...
	public function __construct(string $name, array $flags, Vector3 $pos1, Vector3 $pos2, string $levelName, array $whitelist, AreaManager $plugin){
	...
	public function getLevel() : ?Level{
		return Main::getInstance()->getLevelByName($this->levelName);
	}
