...
class ServersAsyncTask extends AsyncTask{
	/** @var array */
	...
	public function onCompletion(Server $server){
	    $sss = $server->getPluginManager()->getPlugin("ArcaneLobby")->getServerStats();
		if($sss instanceof ServerStats){
			$sss->asyncTaskCallBack($this->getResult(), $this->startTick);
		}else{
			echo("Warning: Async Task started by ArcaneLobby; aborting");
		}
	}
}