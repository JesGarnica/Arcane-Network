    ...
    public function createFormat(Player $player, $faction = false) {
        ...
        if($secondary == "unknown") {
            if($primary == $this->getPrimaryDefault()) {
                $format = $this->getMiscTag("default_rank_prefix") . " " . $username . $this->getMiscTag("chat_message_prefix");
            }
            else {
                $string = "%rank% " . $username . $this->getMiscTag("chat_message_prefix");
            ...
            if($primary == $this->getPrimaryDefault()) {
                ...
                $string = "%rank_s%" . "%rank_p% " . $username . $this->getMiscTag("chat_message_prefix");
